...
function listPlayerAnime(idAnime) {
    var _a;
    return __awaiter(this, void 0, void 0, function () {
        function capitalizeFirstLetter(str) {
            return str[0].toUpperCase() + str.slice(1);
        }
        var body, $, nome, video, dados;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    video = "https://nekowatchapi1.herokuapp.com/get/player/" + (video === null || video === void 0 ? void 0 : video.split("&")[0].split("?")[1]) + "/" + (video === null || video === void 0 ? void 0 : video.split("&d")[1].split("=")[1]);
                    dados = {
                        nome: nome,
                        video: video,
                        creditos: ["caixeta", "kaway"]
                    };
...
exports.default = listPlayerAnime;
