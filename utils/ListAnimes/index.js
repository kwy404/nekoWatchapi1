...
function listAnimes(page) {
    return __awaiter(this, void 0, void 0, function () {
        var urlParam, animes, body, paginationNumbers;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    urlParam = page == 1 ? '/lista' : "lista/page/" + page;
                    return [4 /*yield*/, animesSection_1.default(urlParam, 0)];
                case 1:
                    animes = _a.sent();
                    return [4 /*yield*/, animeflvbr_1.animesRequest.get(urlParam)];
                case 2:
                    body = _a.sent();
