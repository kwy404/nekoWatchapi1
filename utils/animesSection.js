...
function default_1(urlParams, section) {
    return __awaiter(this, void 0, void 0, function () {
        var body, $, idAnimes, imagesAttributes, title, cheerioAnimesList;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, animeflvbr_1.animesRequest.get(urlParams)];
                case 1:
                    body = _a.sent();
                    ...
                    imagesAttributes = [];
                    title = [];
                    cheerioAnimesList = $('.loadscrollleft')[section];
                    $(cheerioAnimesList).find('.item-an').each(function (i, element) {
